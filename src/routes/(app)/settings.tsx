	...
	return (
		<Card className="mt-4">
			<CardHeader>
				...
				<CardDescription>Set your default hourly rate for invoicing.</CardDescription>
			</CardHeader>
			<CardContent>
			...
			<div>
				...
				<Card className="mt-4">
					<CardHeader>
						...
						<CardDescription>Control how the app appears on your desktop.</CardDescription>
					</CardHeader>
					<CardContent className="flex flex-col gap-0">
						...
						<div className="flex items-center justify-between py-3">
							...
							<Switch
								...
								onCheckedChange={(checked) => updateSetting("enableIsland", checked)}
								disabled={!isTauri}
							/>
						</div>
						...
						<div className="flex items-center justify-between py-3">
							...
							<Switch
								...
								onCheckedChange={(checked) => updateSetting("enableTrayTimer", checked)}
								disabled={!isTauri}
							/>
						</div>
					</CardContent>
