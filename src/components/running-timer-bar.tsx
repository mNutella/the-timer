		...
		<>
			...
			>
				<div className="flex min-w-0 items-center gap-3">
					...
					<span className="text-lg font-semibold text-success tabular-nums">{elapsed}</span>
					<span className="truncate text-sm text-muted-foreground">{runningTimer.name}</span>
					<div className="hidden items-center gap-1.5 sm:flex">
						{runningTimer.client && (
							<Badge variant="outline" className="text-xs">
								{runningTimer.client.name}
							</Badge>
						)}
				...
				<Button onClick={handleStop} variant="destructive" size="sm" className="ml-3 shrink-0">
