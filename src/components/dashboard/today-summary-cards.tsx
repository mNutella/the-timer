...
export function TodaySummaryCards({ entryCount }: { entryCount: number | undefined }) {
	...
	const avg = totalDuration !== undefined && count > 0 ? Math.round(totalDuration / count) : 0;

	return (
		<div className="rounded-xl border border-border bg-card px-4 lg:px-6">
			<div className="grid grid-cols-1 divide-y divide-border @xl/main:grid-cols-[1.4fr_1fr_1fr] @xl/main:divide-x @xl/main:divide-y-0">
